(function () {
  ...
  const frToEn = {
    ...
    'Une histoire de confiance, transmise depuis des générations.': 'A legacy of trust, passed down through generations.',
    "Une entreprise familiale bâtie sur l'expérience, la transparence et un service véritablement personnalisé.": 'A family business built on experience, transparency, and genuinely personalized service.',
    'DEPUIS 1942': 'SINCE 1942',
    'Un héritage familial. Une vision moderne.': 'A family legacy. A modern vision.',
    "L'histoire de la famille Sharbo a débuté en 1942 dans le domaine du commerce général et de la vente de véhicules utilitaires à l'extérieur du Canada.": 'The Sharbo family story began in 1942 through general trading and commercial vehicle sales outside Canada.',
    "En 2023, cette expérience familiale s'est poursuivie au Québec avec la création de Sharbo Auto, une entreprise spécialisée dans la vente de véhicules d'occasion soigneusement sélectionnés.": 'In 2023, that family experience continued in Quebec with the launch of Sharbo Auto, specializing in carefully selected pre-owned vehicles.',
    "Notre objectif est simple : rendre l'achat d'un véhicule plus clair, plus humain et plus rassurant, du premier contact jusqu'à la livraison.": 'Our goal is simple: make buying a vehicle clearer, more personal, and more reassuring from the first conversation through delivery.',
    'NOTRE ENGAGEMENT': 'OUR COMMITMENT',
    'Une expérience simple, juste et sans pression.': 'A simple, fair, pressure-free experience.',
    "Nous privilégions une approche transparente et personnalisée pour aider chaque client à trouver un véhicule adapté à ses besoins et à son budget.": 'We take a transparent, personalized approach to help every customer find a vehicle that fits their needs and budget.',
    'Véhicules sélectionnés': 'Carefully selected vehicles',
    "Des véhicules d'occasion choisis avec soin et inspectés avant leur mise en vente.": 'Pre-owned vehicles carefully chosen and inspected before being offered for sale.',
    'Prix justes': 'Fair pricing',
    'Une présentation claire et des prix établis avec transparence.': 'Clear information and pricing presented with transparency.',
    'Service personnalisé': 'Personalized service',
    "Une équipe disponible, à l'écoute et sans pression de vente.": 'A responsive team that listens, without sales pressure.',
    'Financement accessible': 'Flexible financing',
    'Des solutions de financement adaptées à plusieurs situations de crédit.': 'Financing solutions designed for a wide range of credit situations.',
    'POURQUOI SHARBO AUTO': 'WHY SHARBO AUTO',
    'La confiance se construit avec des gestes concrets.': 'Trust is built through meaningful actions.',
    'Véhicules inspectés': 'Inspected vehicles',
    'Chaque véhicule est vérifié avec soin.': 'Every vehicle is carefully reviewed.',
    'Rapport Carfax disponible': 'Carfax report available',
    "L'historique est accessible lorsqu'un rapport est fourni.": 'Vehicle history is available whenever a report is provided.',
    'Aucune pression': 'No pressure',
    'Vous prenez votre décision à votre rythme.': 'Take the time you need to make your decision.',
    'Service rapide': 'Responsive service',
    'Des réponses claires et un suivi efficace.': 'Clear answers and efficient follow-up.',
    'VOTRE PROCHAIN VÉHICULE': 'YOUR NEXT VEHICLE',
    'Découvrez notre sélection.': 'Explore our selection.',
    'Un héritage familial depuis 1942.': 'A family legacy since 1942.',
    "Fondée au Québec en 2023, Sharbo Auto poursuit une tradition familiale née dans le commerce et les véhicules utilitaires en 1942. Aujourd'hui, nous offrons des véhicules d'occasion sélectionnés avec soin, des prix justes et un service sans pression.": 'Founded in Quebec in 2023, Sharbo Auto carries forward a family tradition that began in general trading and commercial vehicles in 1942. Today, we offer carefully selected pre-owned vehicles, fair pricing, and pressure-free service.',
